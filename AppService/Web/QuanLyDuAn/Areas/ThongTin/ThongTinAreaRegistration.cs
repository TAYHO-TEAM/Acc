...
namespace QuanLyDuAn.Areas.ThongTin
{
    public class ThongTinAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute(
              "ThongTin_QLTienDo_TienDoReport",
              "ThongTin/{controller}/{action}/{id}/{unit}",
              new { controller = "QLTienDo", action = "_TienDoReport", id = UrlParameter.Optional, unit = UrlParameter.Optional }
            );
            context.MapRoute(
