...
{
    public class CreateDocumentReleasedAccountsCommandHandler : DocumentReleasedAccountCommandHandler, IRequestHandler<CreateDocumentReleasedAccountCommand, MethodResult<CreateDocumentReleasedAccountCommandResponse>>
    {
