...
{
    public class QuanLyDuAnRepository<T> : IQuanLyDuAnRepository<T> where T : DOBase
    {
        protected readonly QuanLyDuAnContext _dbContext;
        protected readonly MediaOptions _mediaOptions;
        private CancellationToken _cancellationToken = default;
        public QuanLyDuAnRepository(QuanLyDuAnContext dbContext, IOptionsSnapshot<MediaOptions> snapshotOptionsAccessor)
        {
