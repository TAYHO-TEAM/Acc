...
{
    public class WarehouseGoodsStorageConfiguration
    {
        public void Configure(EntityTypeBuilder<WarehouseGoodsStorage> builder)
        {
            builder.ToTable(OperationManagerConstants.WarehouseGoodsStorage_TABLENAME);
            builder.Property(x => x.WarehouseGoodsId).HasColumnName("WarehouseGoodsId").UsePropertyAccessMode(PropertyAccessMode.Field);
            ...
            builder.Property(x => x.PriorityX).HasColumnName("PriorityX").UsePropertyAccessMode(PropertyAccessMode.Field);
            builder.Property(x => x.PriorityY).HasColumnName("PriorityY").UsePropertyAccessMode(PropertyAccessMode.Field);
