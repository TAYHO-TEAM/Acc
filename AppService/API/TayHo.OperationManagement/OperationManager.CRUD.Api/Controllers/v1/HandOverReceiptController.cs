...
{
    public class HandOverReceiptController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.HandOverReceipt_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<HandOverReceipt> _quanLyVanHanhRepository;
        public HandOverReceiptController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<HandOverReceipt> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of HandOverReceipt.
        /// </summary>
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                HandOverReceipt model = new HandOverReceipt();
                if (!string.IsNullOrEmpty(values))
                    JsonConvert.PopulateObject(values, model);
                IFormFileCollection files = Request.Form.Files;
                model.Id = key;
        ...
        /// <summary>
        /// Delete of HandOverReceipt.
        /// </summary>
        /// <param name="HandOverReceipt"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
