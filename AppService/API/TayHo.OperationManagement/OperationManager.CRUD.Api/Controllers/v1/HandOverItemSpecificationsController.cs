...
{
    public class HandOverItemSpecificationsController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.HandOverItemSpecifications_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<HandOverItemSpecifications> _quanLyVanHanhRepository;
        public HandOverItemSpecificationsController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<HandOverItemSpecifications> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of HandOverItemSpecifications.
        /// </summary>
        ...
        /// <summary>
        /// Create  of HandOverItemSpecifications.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPost]
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
            ...
            try
            {
                ...
                var model = new HandOverItemSpecifications();
        ...
        /// <summary>
        /// Update of HandOverItemSpecifications.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPut]
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                HandOverItemSpecifications model = new HandOverItemSpecifications();
                if (!string.IsNullOrEmpty(values))
                    JsonConvert.PopulateObject(values, model);
                IFormFileCollection files = Request.Form.Files;
                model.Id = key;
        ...
        /// <summary>
        /// Delete of HandOverItemSpecifications.
        /// </summary>
        /// <param name="HandOverItemSpecifications"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
