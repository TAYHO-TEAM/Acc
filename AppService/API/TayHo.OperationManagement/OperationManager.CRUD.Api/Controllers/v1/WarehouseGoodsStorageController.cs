...
{
    public class WarehouseGoodsStorageController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.WarehouseGoodsStorage_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<WarehouseGoodsStorage> _quanLyVanHanhRepository;
        public WarehouseGoodsStorageController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<WarehouseGoodsStorage> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of WarehouseGoodsStorage.
        /// </summary>
        ...
        /// <summary>
        /// Create  of WarehouseGoodsStorage.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPost]
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
            ...
            try
            {
                ...
                var model = new WarehouseGoodsStorage();
        ...
        /// <summary>
        /// Update of WarehouseGoodsStorage.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPut]
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                WarehouseGoodsStorage model = new WarehouseGoodsStorage();
                if (!string.IsNullOrEmpty(values))
                    JsonConvert.PopulateObject(values, model);
                IFormFileCollection files = Request.Form.Files;
                model.Id = key;
        ...
        /// <summary>
        /// Delete of WarehouseGoodsStorage.
        /// </summary>
        /// <param name="WarehouseGoodsStorage"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
