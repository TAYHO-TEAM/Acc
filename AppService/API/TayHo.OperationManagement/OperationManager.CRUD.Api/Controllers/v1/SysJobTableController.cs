...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysJobTableController : APIControllerBase
    {
        ...
        public string nameEF = OperationManagerConstants.SysJobTable_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<SysJobTable> _quanLyVanHanhRepository;
        public SysJobTableController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<SysJobTable> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of SysJobTable.
        /// </summary>
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                SysJobTable model = new SysJobTable();
                if (!string.IsNullOrEmpty(values))
                    JsonConvert.PopulateObject(values, model);
                IFormFileCollection files = Request.Form.Files;
                model.Id = key;
        ...
        /// <summary>
        /// Delete of SysJobTable.
        /// </summary>
        /// <param name="SysJobTable"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
