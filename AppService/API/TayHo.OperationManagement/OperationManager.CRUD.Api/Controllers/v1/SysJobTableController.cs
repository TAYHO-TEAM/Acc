...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysJobTableController : APIControllerBase
    {
        ...
        public string nameEF = ProjectManagerConstants.SysJobTable_TABLENAME;
        protected readonly IQuanLyDuAnRepository<SysJobTable> _quanLyDuAnRepository;
        public SysJobTableController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyDuAnRepository<SysJobTable> quanLyDuAnRepository) : base(mapper, httpContextAccessor)
        {
