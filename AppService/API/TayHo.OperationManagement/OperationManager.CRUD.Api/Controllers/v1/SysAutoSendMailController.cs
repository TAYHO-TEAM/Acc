...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysAutoSendMailController : APIControllerBase
    {
        ...
        public string nameEF = OperationManagerConstants.SysAutoSendMail_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<SysAutoSendMail> _quanLyVanHanhRepository;
        public SysAutoSendMailController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<SysAutoSendMail> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of SysAutoSendMail.
        /// </summary>
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                SysAutoSendMail model = new SysAutoSendMail();
                if (!string.IsNullOrEmpty(values))
                    JsonConvert.PopulateObject(values, model);
                IFormFileCollection files = Request.Form.Files;
                model.Id = key;
        ...
        /// <summary>
        /// Delete of SysAutoSendMail.
        /// </summary>
        /// <param name="SysAutoSendMail"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
