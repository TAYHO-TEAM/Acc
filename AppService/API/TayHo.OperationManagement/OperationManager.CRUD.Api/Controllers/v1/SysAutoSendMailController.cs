...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysAutoSendMailController : APIControllerBase
    {
        ...
        public string nameEF = ProjectManagerConstants.SysAutoSendMail_TABLENAME;
        protected readonly IQuanLyDuAnRepository<SysAutoSendMail> _quanLyDuAnRepository;
        public SysAutoSendMailController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyDuAnRepository<SysAutoSendMail> quanLyDuAnRepository) : base(mapper, httpContextAccessor)
        {
