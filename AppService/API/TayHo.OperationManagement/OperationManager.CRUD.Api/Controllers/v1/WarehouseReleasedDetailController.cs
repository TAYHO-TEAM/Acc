...
{
    public class WarehouseReleasedDetailController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.WarehouseReleasedDetail_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<WarehouseReleasedDetail> _quanLyVanHanhRepository;
        public WarehouseReleasedDetailController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<WarehouseReleasedDetail> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of WarehouseReleasedDetail.
        /// </summary>
        ...
        /// <summary>
        /// Create  of WarehouseReleasedDetail.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPost]
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
            ...
            try
            {
                ...
                var model = new WarehouseReleasedDetail();
        ...
        /// <summary>
        /// Update of WarehouseReleasedDetail.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPut]
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                WarehouseReleasedDetail model = new WarehouseReleasedDetail();
                JsonConvert.PopulateObject(values, model);
                model.Id = key;
        ...
        /// <summary>
        /// Delete of WarehouseReleasedDetail.
        /// </summary>
        /// <param name="WarehouseReleasedDetail"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
