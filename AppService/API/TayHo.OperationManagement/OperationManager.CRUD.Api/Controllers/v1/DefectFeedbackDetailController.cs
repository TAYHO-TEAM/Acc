...
{
    public class DefectFeedbackDetailController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.DefectFeedbackDetail_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<DefectFeedbackDetail> _quanLyVanHanhRepository;
        public DefectFeedbackDetailController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<DefectFeedbackDetail> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of DefectFeedbackDetail.
        /// </summary>
        ...
        /// <summary>
        /// Create  of DefectFeedbackDetail.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPost]
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
            ...
            try
            {
                ...
                var model = new DefectFeedbackDetail();
        ...
        /// <summary>
        /// Update of DefectFeedbackDetail.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPut]
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                DefectFeedbackDetail model = new DefectFeedbackDetail();
                if (!string.IsNullOrEmpty(values))
                    JsonConvert.PopulateObject(values, model);
                IFormFileCollection files = Request.Form.Files;
                model.Id = key;
        ...
        /// <summary>
        /// Delete of DefectFeedbackDetail.
        /// </summary>
        /// <param name="DefectFeedbackDetail"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
