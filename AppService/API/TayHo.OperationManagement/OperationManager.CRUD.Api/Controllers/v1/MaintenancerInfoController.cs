...
{
    public class MaintenancerInfoController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.MaintenancerInfo_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<MaintenancerInfo> _quanLyVanHanhRepository;
        public MaintenancerInfoController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<MaintenancerInfo> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of MaintenancerInfo.
        /// </summary>
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
            ...
            try
            {
                ...
                var model = new MaintenancerInfo();
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                MaintenancerInfo model = new MaintenancerInfo();
                JsonConvert.PopulateObject(values, model);
                model.Id = key;
        ...
        /// <summary>
        /// Delete of MaintenancerInfo.
        /// </summary>
        /// <param name="MaintenancerInfo"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
