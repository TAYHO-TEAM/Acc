...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysTableManagerController : APIControllerBase
    {
        ...
        public string nameEF = ProjectManagerConstants.SysTableManager_TABLENAME;
        protected readonly IQuanLyDuAnRepository<SysTableManager> _quanLyDuAnRepository;
        public SysTableManagerController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyDuAnRepository<SysTableManager> quanLyDuAnRepository) : base(mapper, httpContextAccessor)
        {
