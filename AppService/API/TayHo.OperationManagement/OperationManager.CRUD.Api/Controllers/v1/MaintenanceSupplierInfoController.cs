...
{
    public class MaintenanceSupplierInfoController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.MaintenanceSupplierInfo_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<MaintenanceSupplierInfo> _quanLyVanHanhRepository;
        public MaintenanceSupplierInfoController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<MaintenanceSupplierInfo> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of MaintenanceSupplierInfo.
        /// </summary>
        ...
        /// <summary>
        /// Create  of MaintenanceSupplierInfo.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPost]
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
            ...
            try
            {
                ...
                var model = new MaintenanceSupplierInfo();
        ...
        /// <summary>
        /// Update of MaintenanceSupplierInfo.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPut]
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                MaintenanceSupplierInfo model = new MaintenanceSupplierInfo();
                JsonConvert.PopulateObject(values, model);
                model.Id = key;
        ...
        /// <summary>
        /// Delete of MaintenanceSupplierInfo.
        /// </summary>
        /// <param name="MaintenanceSupplierInfo"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
