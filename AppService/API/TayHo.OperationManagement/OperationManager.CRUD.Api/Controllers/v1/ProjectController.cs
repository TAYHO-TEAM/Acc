...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class ProjectController : APIControllerBase
    {
        ...
        public string nameEF = OperationManagerConstants.Project_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<Project> _quanLyVanHanhRepository;
        public ProjectController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<Project> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
