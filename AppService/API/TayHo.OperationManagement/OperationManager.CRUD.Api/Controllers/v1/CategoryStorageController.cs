...
{
    public class CategoryStorageController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.CategoryStorage_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<CategoryStorage> _quanLyVanHanhRepository;
        public CategoryStorageController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<CategoryStorage> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of CategoryStorage.
        /// </summary>
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                CategoryStorage model = new CategoryStorage();
                JsonConvert.PopulateObject(values, model);
                model.Id = key;
        ...
        /// <summary>
        /// Delete of CategoryStorage.
        /// </summary>
        /// <param name="CategoryStorage"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
