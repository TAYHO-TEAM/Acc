...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysJobParameterController : APIControllerBase
    {
        ...
        public string nameEF = ProjectManagerConstants.SysJobParameter_TABLENAME;
        protected readonly IQuanLyDuAnRepository<SysJobParameter> _quanLyDuAnRepository;
        public SysJobParameterController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyDuAnRepository<SysJobParameter> quanLyDuAnRepository) : base(mapper, httpContextAccessor)
        {
