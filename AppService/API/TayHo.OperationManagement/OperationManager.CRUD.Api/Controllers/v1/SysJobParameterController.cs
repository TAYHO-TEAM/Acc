...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysJobParameterController : APIControllerBase
    {
        ...
        public string nameEF = OperationManagerConstants.SysJobParameter_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<SysJobParameter> _quanLyVanHanhRepository;
        public SysJobParameterController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<SysJobParameter> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of SysJobParameter.
        /// </summary>
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                SysJobParameter model = new SysJobParameter();
                if (!string.IsNullOrEmpty(values))
                    JsonConvert.PopulateObject(values, model);
                IFormFileCollection files = Request.Form.Files;
                model.Id = key;
        ...
        /// <summary>
        /// Delete of SysJobParameter.
        /// </summary>
        /// <param name="SysJobParameter"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
