...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class ConversationController : APIControllerBase
    {
        ...
        public string nameEF = OperationManagerConstants.Conversation_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<Conversation> _quanLyVanHanhRepository;
        public ConversationController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<Conversation> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
