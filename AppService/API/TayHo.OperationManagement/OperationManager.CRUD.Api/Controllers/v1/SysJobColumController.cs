...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysJobColumController : APIControllerBase
    {
        ...
        public string nameEF = ProjectManagerConstants.SysJobColum_TABLENAME;
        protected readonly IQuanLyDuAnRepository<SysJobColum> _quanLyDuAnRepository;
        public SysJobColumController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyDuAnRepository<SysJobColum> quanLyDuAnRepository) : base(mapper, httpContextAccessor)
        {
