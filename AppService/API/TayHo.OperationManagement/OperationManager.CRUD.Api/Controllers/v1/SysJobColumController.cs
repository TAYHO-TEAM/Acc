...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysJobColumController : APIControllerBase
    {
        ...
        public string nameEF = OperationManagerConstants.SysJobColum_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<SysJobColum> _quanLyVanHanhRepository;
        public SysJobColumController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<SysJobColum> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of SysJobColum.
        /// </summary>
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                SysJobColum model = new SysJobColum();
                if (!string.IsNullOrEmpty(values))
                    JsonConvert.PopulateObject(values, model);
                IFormFileCollection files = Request.Form.Files;
                model.Id = key;
        ...
        /// <summary>
        /// Delete of SysJobColum.
        /// </summary>
        /// <param name="SysJobColum"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
