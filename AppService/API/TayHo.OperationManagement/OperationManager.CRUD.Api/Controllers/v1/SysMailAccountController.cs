...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysMailAccountController : APIControllerBase
    {
        ...
        public string nameEF = OperationManagerConstants.SysMailAccount_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<SysMailAccount> _quanLyVanHanhRepository;
        public SysMailAccountController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<SysMailAccount> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of SysMailAccount.
        /// </summary>
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                SysMailAccount model = new SysMailAccount();
                if (!string.IsNullOrEmpty(values))
                    JsonConvert.PopulateObject(values, model);
                IFormFileCollection files = Request.Form.Files;
                model.Id = key;
        ...
        /// <summary>
        /// Delete of SysMailAccount.
        /// </summary>
        /// <param name="SysMailAccount"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
