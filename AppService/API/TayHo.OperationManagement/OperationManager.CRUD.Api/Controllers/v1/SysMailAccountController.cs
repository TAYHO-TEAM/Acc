...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysMailAccountController : APIControllerBase
    {
        ...
        public string nameEF = ProjectManagerConstants.SysMailAccount_TABLENAME;
        protected readonly IQuanLyDuAnRepository<SysMailAccount> _quanLyDuAnRepository;
        public SysMailAccountController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyDuAnRepository<SysMailAccount> quanLyDuAnRepository) : base(mapper, httpContextAccessor)
        {
