...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class SysSettingController : APIControllerBase
    {
        ...
        public string nameEF = OperationManagerConstants.SysSetting_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<SysSetting> _quanLyVanHanhRepository;
        public SysSettingController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<SysSetting> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
