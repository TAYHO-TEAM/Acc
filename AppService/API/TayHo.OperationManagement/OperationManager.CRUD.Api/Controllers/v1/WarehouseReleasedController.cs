...
{
    public class WarehouseReleasedController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.WarehouseReleased_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<WarehouseReleased> _quanLyVanHanhRepository;
        public WarehouseReleasedController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<WarehouseReleased> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of WarehouseReleased.
        /// </summary>
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
            ...
            try
            {
                ...
                var model = new WarehouseReleased();
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                WarehouseReleased model = new WarehouseReleased();
                JsonConvert.PopulateObject(values, model);
                model.Id = key;
        ...
        /// <summary>
        /// Delete of WarehouseReleased.
        /// </summary>
        /// <param name="WarehouseReleased"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
