...
{
    public class WarehouseStorageController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.WarehouseStorage_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<WarehouseStorage> _quanLyVanHanhRepository;
        public WarehouseStorageController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<WarehouseStorage> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of WarehouseStorage.
        /// </summary>
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
            ...
            try
            {
                ...
                var model = new WarehouseStorage();
        ...
        /// <summary>
        /// Delete of WarehouseStorage.
        /// </summary>
        /// <param name="WarehouseStorage"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
