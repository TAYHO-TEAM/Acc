...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class LogEventController : APIControllerBase
    {
        ...
        public string nameEF = OperationManagerConstants.LogEvent_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<LogEvent> _quanLyVanHanhRepository;
        public LogEventController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<LogEvent> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
