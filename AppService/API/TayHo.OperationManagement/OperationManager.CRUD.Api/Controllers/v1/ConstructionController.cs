...
namespace OperationManager.CRUD.Api.Controllers.v1
{
    public class ConstructionController : APIControllerBase
    {
        ...
        public string nameEF = OperationManagerConstants.Construction_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<Construction> _quanLyVanHanhRepository;
        public ConstructionController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<Construction> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of Construction.
        /// </summary>
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                Construction model = new Construction();
                JsonConvert.PopulateObject(values, model);
                model.Id = key;
