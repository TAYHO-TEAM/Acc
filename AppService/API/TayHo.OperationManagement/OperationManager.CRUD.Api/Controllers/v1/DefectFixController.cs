...
{
    public class DefectFixController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.DefectFix_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<DefectFix> _quanLyVanHanhRepository;
        public DefectFixController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<DefectFix> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of DefectFix.
        /// </summary>
