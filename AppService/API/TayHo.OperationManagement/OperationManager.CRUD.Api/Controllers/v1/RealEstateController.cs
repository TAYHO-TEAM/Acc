...
{
    public class RealEstateController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.RealEstate_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<RealEstate> _quanLyVanHanhRepository;
        public RealEstateController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<RealEstate> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                RealEstate model = new RealEstate();
                JsonConvert.PopulateObject(values, model);
                model.Id = key;
