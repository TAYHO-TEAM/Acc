...
{
    public class HandOverReceiptDetailController : APIControllerBase
    {
        const string VALIDATION_ERROR = "The request failed due to a validation error";
        public string nameEF = OperationManagerConstants.HandOverReceiptDetail_TABLENAME;
        protected readonly IQuanLyVanHanhRepository<HandOverReceiptDetail> _quanLyVanHanhRepository;
        public HandOverReceiptDetailController(IMapper mapper, IHttpContextAccessor httpContextAccessor, IQuanLyVanHanhRepository<HandOverReceiptDetail> quanLyVanHanhRepository) : base(mapper, httpContextAccessor)
        {
            _quanLyVanHanhRepository = quanLyVanHanhRepository;
        }
        /// <summary>
        /// Get List of HandOverReceiptDetail.
        /// </summary>
        ...
        /// <summary>
        /// Create  of HandOverReceiptDetail.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPost]
        ...
        public async Task<IActionResult> Post([FromForm]string values)
      {
            ...
            try
            {
                ...
                var model = new HandOverReceiptDetail();
        ...
        /// <summary>
        /// Update of HandOverReceiptDetail.
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [HttpPut]
        ...
        public async Task<IActionResult> Put([FromForm] int key, [FromForm] string values)
        {
            try
            {
                HandOverReceiptDetail model = new HandOverReceiptDetail();
                if (!string.IsNullOrEmpty(values))
                    JsonConvert.PopulateObject(values, model);
                IFormFileCollection files = Request.Form.Files;
                model.Id = key;
        ...
        /// <summary>
        /// Delete of HandOverReceiptDetail.
        /// </summary>
        /// <param name="HandOverReceiptDetail"></param>
        /// <returns></returns>
        [HttpDelete]
        [ProducesResponseType(typeof(VoidMethodResult), (int)HttpStatusCode.BadRequest)]
